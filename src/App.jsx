          ...
          <div className="relative isolate overflow-hidden bg-gradient-to-br from-gray-800/90 to-gray-900/80 px-8 py-16 shadow-2xl sm:rounded-[40px] sm:px-16 md:py-24 lg:flex lg:items-center lg:gap-x-20 lg:px-24 lg:py-32 backdrop-blur-sm border border-gray-700/30">
            ...
            <div className="mx-auto max-w-2xl text-center lg:mx-0 lg:flex-auto lg:py-32 lg:text-left">
              ...
              <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-6 lg:justify-start">
                ...
                <button className="flex items-center text-lg font-medium text-blue-400 hover:text-blue-300 transition-colors duration-300 group">
                  Ver demostración
...
// Componente reutilizable para funciones
function FeatureCard({ title, description }) {
  return (
    <div className="bg-white shadow-md rounded-lg p-6 text-left hover:shadow-xl transition-shadow">
